<template>
  ...
  <div class="color green" :class="{ flicker: isAnimated }">
...
export default {
  ...
  mounted() {
    ...
    this.$store.dispatch("setCameFromValue", "green");
    this.$store.dispatch("setCurrentColor", "green");
